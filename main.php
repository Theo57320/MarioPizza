                ...
                if(password_verify($password_value,$pass)){
                    ...
                    switch (readline('Enter a number please :')){
                        ...
                        case 2:
                            ...
                            switch (readline('Enter a number please : ')){
                                ...
                                case 4:
                                    ...
                                    $New_Ingredient_Name = readline('Type the name of the new Ingredient please :');
                                    $New_Ingredient_Price = readline('Type the price of the new Ingredient please (please use "." instead of "," :');
                                    $New_Ingredient_Stock = readline('Type the stock of the new Ingredient please :');
                                    $New_Ingredient = new Ingredients($New_Ingredient_Name,$New_Ingredient_Price,$New_Ingredient_Stock,$IngredientsList);
                        ...
                        case 3:
                            ...
                            echo "\nIngredients :\n\n";
                            ListPizza::ListPizzasStock($IngredientsList);
